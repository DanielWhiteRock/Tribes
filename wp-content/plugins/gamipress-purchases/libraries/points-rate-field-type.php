...
if( ! function_exists( 'gamipress_render_points_rate_field_type' ) ) {
    ...
    function gamipress_render_points_rate_field_type( $field, $value, $object_id, $object_type, $field_type ) {
        ...
        if( $field->args( 'points_type' ) ) {
            $points_plural_name = gamipress_get_post_meta( $field->args( 'points_type' ), '_gamipress_plural_name', true );
        } else {
            $points_plural_name = gamipress_get_post_meta( $object_id, '_gamipress_plural_name', true );
        }
