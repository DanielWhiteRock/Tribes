<?php
/**
 * Achievement Purchase Form template
 *
 * This template can be overridden by copying it to yourtheme/gamipress/purchases/achievement-purchase-form.php
 * To override a specific achievement type just copy it as yourtheme/gamipress/purchases/achievement-purchase-form-{achievement-type}.php
 */
...
<fieldset id="gamipress-purchases-form-wrapper" class="gamipress-purchases-form-wrapper gamipress-purchases-points-purchase-form-wrapper">
    ...
    <form id="<?php echo $a['form_id']; ?>" class="gamipress-purchases-form gamipress-purchases-points-purchase-form" action="" method="POST">
        ...
        <?php
        /**
         * Before render achievement purchase form
         *
         * @param $user_id          integer     User ID
         * @param $user_details     array       User billing details
         * @param $achievement_id   integer     Achievement to be purchased
         * @param $template_args    array       Template received arguments
         */
        do_action( 'gamipress_purchases_before_achievement_purchase_form', $user_id, $user_details, $achievement_id, $a ); ?>

        <fieldset class="gamipress-purchases-form-achievement-wrapper">
        ...
        <?php else : ?>
            ...
            <?php gamipress_get_template_part( 'personal-info-form', $achievement_type ); ?>

            <?php // Setup the billing details ?>
            <?php gamipress_get_template_part( 'billing-address-form', $achievement_type ); ?>

            <?php // Setup the payment gateways ?>
            <?php gamipress_get_template_part( 'gateways-form', $achievement_type ); ?>

            <?php // Setup the acceptance form ?>
            <?php gamipress_get_template_part( 'acceptance-form', $achievement_type ); ?>
            ...
            <input type="hidden" name="purchase_type" value="achievement">
        ...
        <?php
        /**
         * After render achievement purchase form
         *
         * @param $user_id          integer     User ID
         * @param $user_details     array       User billing details
         * @param $achievement_id   integer     Achievement to be purchased
         * @param $template_args    array       Template received arguments
         */
        do_action( 'gamipress_purchases_after_achievement_purchase_form', $user_id, $user_details, $achievement_id, $a ); ?>
